...
class KittyAdmin extends AbstractAdmin
{
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        ...
        $listMapper->addIdentifier('image', null, array('template' =>'KittyAdmin/kitty_list_field.html.twig'));
    ...
    protected function configureShowFields(ShowMapper $showMapper)
    {
        ...
        $showMapper->add('race');
        $showMapper->add('image', null, array('template' =>'KittyAdmin/kitty_show_field.html.twig'));
    }
